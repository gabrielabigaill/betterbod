    ...
    <footer className="bg-[#1a1a2e] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-4">
              Move. Nourish. Thrive.<br />
              Your transformation starts here.
            </p>
            <div className="flex gap-4">
              {['Instagram', 'TikTok', 'YouTube'].map(s => (
                <a key={s} href="#" aria-label={s}
                  className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/50 hover:text-white hover:border-[#FF6357] transition-colors text-xs">
                  {s[0]}
                </a>
              ))}
            </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/30">
          ...
          <p className="text-xs">
            Prices shown in your local currency. All memberships auto-renew. Cancel anytime.
          </p>
        </div>
      </div>
    </footer>
